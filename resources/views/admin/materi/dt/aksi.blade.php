<div class="text-center">
    <form action="{{ route('materi.destroy', Crypt::encrypt($model->id)) }}" method="POST">
        @method('DELETE')
        @csrf
        <div class="btn-group" role="group">
            <a href="{{ route('materi.learning', $model->order) }}" type="button" class="btn btn-primary"
                data-toggle="tooltip" title="Lihat data"><i class="bx bx-show"></i></a>
            <a href="{{ route('materi.edit', Crypt::encrypt($model->id)) }}" type="button" class="btn btn-warning"
